...
## 1. THIẾT LẬP CHUNG (SETTINGS)

- **Format:** 4-Koma Manga (Vertical Strip).
- **Style:** Anime Style, [Black & White / Full Color].
- **Text Language:** Vietnamese (Viết chính xác nội dung trong ngoặc kép).
- **SFX Language:** Vietnamese.
...
- **Manpu/VFX (Hiệu ứng):** [Speed Lines / Sweat Drop / Sparkles...].
- **Dialogue (Thoại):** "[Lời thoại tiếng Việt]"
- **SFX (Âm thanh):** [CLACK / BOOM / PING...]
...
- **Format:** 4-Koma Manga.
- **Nhân vật:** Junior (Áo cam), Senior (Áo 404).
